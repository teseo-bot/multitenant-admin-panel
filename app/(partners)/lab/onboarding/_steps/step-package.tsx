  ...
  return (
    <>
      ...
      <CardContent className="space-y-6">
        ...
        {packageCreated && (
          <Alert className="bg-chart-2/10 dark:bg-chart-2/20 border-chart-2/40 dark:border-chart-2/40">
            <AlertDescription className="text-chart-2 dark:text-chart-2">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            {HOCFLIT_SYSTEMS.map((system) => (
              <label
                key={system.value}
                className="flex items-center gap-2 cursor-pointer p-2 rounded hover:bg-muted dark:hover:bg-card"
              >
                <Checkbox
